  ...
  sections: DetailsDTO['sections'] = [
    {
      ...
      table: [
        { th: "Registration", td: "{{registration}}", editable: false, format: 'UPPERCASE' },
        { th: "ICAO TYPE", td: "{{aircraftType.type}}", editable: true, format: 'UPPERCASE', autocomplete: true},
        { th: "Model", td: "{{aircraftType.model}}", editable: false, format: null },
        { th: "Category", td: "{{aircraftType.category}}", editable: false, format: null }
      ]
    },
    // {
    //   title: "Wynajem",
